...
const HUD = ({ level, xp, totalXp, activePowers, onBack }: any) => (
  <div style={{ position: 'sticky', top: 0, background: 'rgba(15, 0, 79, 0.95)', backdropFilter: 'blur(20px)', borderBottom: '2px solid #00D6CC', padding: '14px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 100, boxShadow: '0 4px 30px rgba(0,0,0,0.3)' }}>
    <button onClick={onBack} style={{ background: 'transparent', border: '1.5px solid rgba(0,214,204,0.4)', color: '#00D6CC', padding: '8px 18px', borderRadius: '4px', cursor: 'pointer', fontSize: '10px', fontWeight: 900, letterSpacing: '2px', textTransform: 'uppercase', transition: '0.3s' }} onMouseEnter={e => { e.currentTarget.style.background = '#00D6CC'; e.currentTarget.style.color = '#0F004F'; }}>
      ÔåÉ SALIR AL ESPACIO
    </button>
    
    <div style={{ textAlign: 'center' }}>
      <div style={{ fontSize: '8px', color: '#ED1650', letterSpacing: '4px', fontWeight: 900, textTransform: 'uppercase', marginBottom: '2px' }}>TERMINAL DE EXPLORACI├ôN ESTRAT├ëGICA</div>
      <div style={{ 
        fontSize: '28px', 
        fontWeight: 900, 
        letterSpacing: '2px', 
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
      ...
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '9px', color: 'rgba(255,255,255,0.6)', fontWeight: 800, marginBottom: '6px' }}>
          <span>PROGRESO DE COMPRENSI├ôN</span>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '16px', marginBottom: '28px' }}>
            <div style={{ flex: 1, padding: '12px', background: 'rgba(15, 0, 79, 0.4)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <div style={{ fontSize: '9px', color: 'rgba(255,255,255,0.4)', fontWeight: 800, letterSpacing: '1px' }}>M├ôDULOS</div>
            </div>
            <div style={{ flex: 1, padding: '12px', background: 'rgba(15, 0, 79, 0.4)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.05)' }}>
              <div style={{ fontSize: '22px', fontWeight: 900, color: '#fff' }}>{p.time.toUpperCase()}</div>
              <div style={{ fontSize: '9px', color: 'rgba(255,255,255,0.4)', fontWeight: 800, letterSpacing: '1px' }}>DURACI├ôN</div>
            </div>
          </div>
          ...
          >
            {isCompleted ? 'REVISAR CONTENIDO' : 'INICIAR EXPLORACI├ôN'}
          </button>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div style={{ 
        ...
        <button onClick={onBack} style={{ 
          ...
          <ArrowLeft size={16} /> MAPA GAL├üCTICO
        </button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <div>
            <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.6)', fontWeight: 900, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: 2 }}>M├ôDULO DE APRENDIZAJE</div>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 48, alignItems: 'center' }}>
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: 13, color: '#99CC33', fontWeight: 900, display: 'flex', alignItems: 'center', gap: 6, justifyContent: 'flex-end' }}>
              <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#99CC33' }} /> EXPLORACI├ôN ACTIVA
            </div>
          </div>
          <div style={{ height: 40, width: 1, background: 'rgba(255,255,255,0.2)' }} />
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.5)', fontWeight: 800 }}>DURACI├ôN</div>
                ...
                {node.consejo && node.consejo !== '-' && (
                  <div style={{ 
                    ...
                    <div style={{ fontSize: 13, color: '#78350F', fontWeight: 600, fontStyle: 'italic' }}>
                      <span style={{ fontWeight: 800, textTransform: 'uppercase', fontSize: 10, color: '#B45309', display: 'block', marginBottom: 2 }}>Consejo Estrat├®gico</span>
                      {node.consejo}
                    </div>
                  </div>
                )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 30 }}>
          <div style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', borderRadius: 24, padding: 40, boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
              <span style={{ fontSize: 12, color: '#858585', fontWeight: 600 }}>Total de M├│dulos</span>
              <span style={{ fontSize: 13, fontWeight: 900, color: '#1B0088' }}>{nodes.length} N├│dulos</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 40 }}>
              <span style={{ fontSize: 12, color: '#858585', fontWeight: 600 }}>Certificaci├│n</span>
          ...
          <div style={{ background: '#0F004F', borderRadius: 24, padding: 36, position: 'relative', overflow: 'hidden' }}>
             ...
             <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.8)', lineHeight: 1.7, fontStyle: 'italic', position: 'relative', zIndex: 1 }}>
               "Los conceptos JETS vinculan la cultura LATAM con la excelencia operativa. Mantenga el enfoque en la mirada del l├¡der."
             </div>
          </div>
        </div>
      ...
      <div style={{ position: 'relative', paddingTop: '40px', paddingBottom: '100px', overflowY: 'auto', overflowX: 'hidden' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '60px' }}>
          <div style={{ 
            ...
            ­ƒù║´©Å ELIGE TU CAMINO ┬À TODOS LOS PODERES DISPONIBLES Ô£¿
          </div>
        </div>
...
export const TechBaseView = ({ 
  ...
  listIcon, 
  children,
  headerTitle = "SEC-A2 ┬À ENGINEERING",
  footerTitle = "TERMINAL DE INGENIER├ìA",
  topDecalLeft = "Universo Training",
  topDecalRight = "Customer Care & Sales",
  sideDecalLeft = "Guardianes",
  sideDecalRight = "Capacitaci├│n",
  footerLogo = null,
  description = "Acced├® a manuales t├®cnicos, gu├¡as de procedimientos y recursos de soporte para operaciones."
}: any) => {
  return (
    <div style={{ 
      minHeight: '100vh', 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          ...
          <div style={{ border: `1px solid #ED1650`, background: 'rgba(11,0,51,0.8)', color: '#ED1650', padding: '6px 16px', borderRadius: 4, fontSize: 11, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 8, boxShadow: `inset 0 0 10px rgba(237, 22, 80, 0.4)` }}>
            P├üGINAS PUBLICADAS: <span style={{ color: '#ffffff' }}>{links ? links.length : 0}</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: '60px 40px', maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 5, flex: 1, width: '100%' }}>
          ...
          >
            ...
            <div style={{ flex: 1, position: 'relative', zIndex: 5 }}>
              <div style={{ fontSize: 11, color: '#ED1650', letterSpacing: '0.3em', marginBottom: 10, fontWeight: 900, textTransform: 'uppercase' }}>
                MANTENIMIENTO ┬À PROTOCOLOS ┬À SOPORTE
              </div>
        ...
        <div style={{ marginBottom: 24, display: 'flex', alignItems: 'center', gap: 20 }}>
          <div>
            <div style={{ fontSize: 11, color: '#ED1650', letterSpacing: '0.2em', marginBottom: 4, fontWeight: 900, textTransform: 'uppercase' }}>REGISTROS T├ëCNICOS</div>
            ...
            >
              ...
              <div style={{ flex: 1, zIndex: 2 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.4)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                  <div>STATUS: <span style={{ color: '#22c55e' }}>ÔùÅ AVAILABLE</span></div>
...
export const IngenieriaView = ({ links, onBack, title, subtitle }: any) => {
  ...
  return (
    <TechBaseView
      ...
      headerTitle="MANTENIMIENTO ┬À PROTOCOLOS ┬À SOPORTE"
      footerTitle="TALLER T├ëCNICO"
    />
  );
};
...
export const LaboratorioView = ({ links, rutaData, onBack, onNavigateRuta, title, subtitle }: any) => {
  ...
  return (
    <TechBaseView
      title={title || 'PORTAL DE L├ìDERES'}
      subtitle={subtitle || 'Lab. de Estrategia: expediciones de formaci├│n y an├ílisis de datos en tiempo real.'}
      links={links}
      onBack={onBack}
      themeColor={themeColor}
      heroIcon={heroIcon}
    ...
    >
      {rutaData && rutaData.length > 0 && (
        ...
        >
          ...
          <div style={{ flex: 1, zIndex: 2 }}>
            <div style={{ fontSize: 10, color: themeColor, letterSpacing: '0.2em', fontWeight: 900, marginBottom: 4, textShadow: `0 0 8px ${themeColor}` }}>PROGRAMA FORMATIVO ┬À CAPA LIDERAZGO</div>
            <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: '0.02em', color: '#ffffff', textTransform: 'uppercase', marginBottom: 8 }}>RUTA DEL L├ìDER GUARDI├üN</div>
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', fontWeight: 500 }}>
              {rutaData.length} Nodos ┬À Mapa Visual Interactivo
            </div>
          </div>
...
export const SuministrosView = ({ links, onBack, title, subtitle }: any) => {
  ...
  return (
    <TechBaseView
      title={title || 'M├ôDULO SUMINISTROS'}
      subtitle={subtitle || 'Gesti├│n de recursos, formularios operativos y control de inventario.'}
      links={links}
      onBack={onBack}
      themeColor={themeColor}
      heroIcon={heroIcon}
      ...
      headerTitle="MANTENIMIENTO ┬À PROTOCOLOS ┬À SOPORTE"
      footerTitle="M├ôDULO SUMINISTROS"
      description="Formularios de solicitud, inventario y recursos log├¡sticos."
    />
  );
};
...
export const OperacionesView = ({ links, onBack, title, subtitle }: any) => {
  ...
  return (
    <TechBaseView
      ...
      description="Recursos de instrucci├│n, monitoreo y operaciones de vuelo."
    />
  );
};

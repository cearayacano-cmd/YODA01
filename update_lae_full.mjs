...
const laeSections = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        tema: "MSP",
        detalhe: "- Instrutor explica o passo a paso de como encontrar o MSP via A360 e informa a finalidade de ter o conhecimento deste manual. (Call Center temos o PIC e nos aeroportos os agentes usam o MSP)\nBrevemente destaca os capítulos con os temas mais recorrentes: Capítulo 10 - Assentos, Capítulo 18 - Contingências, Capítulo 19 - Sobre Reserva (Overbooking)",
        tiempo: "1:00:00",
      ...
      },
      {
        ...
        detalhe: "- Divisão em grupos para resumo de temas específicos sobre reembolsos e compensações legais.",
        tiempo: "00:30:00",
        herramientas: [],
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        detalhe: "- Instrutor descreve as informações que são imprescindíveis para cada tema PI. Enfatiza a qualidade e respostas completas.",
        tiempo: "01:00:00",
        herramientas: [{ tipo: "PPT", url: "https://docs.google.com/presentation/d/1i2KGD5u9fmSgq9rhlaqAiC25qsnO-6PDbsHL255jo64/edit?slide=id.g3d5e41808b5_0_971#slide=id.g3d5e41808b5_0_971" }],
        iaPic: [],
        consejo: ""
...
console.log('LAE_DATA fully updated in data.ts');

...
// The original file ends at line 3045 (before I appended HVC_DATA)
// Wait, I should probably just find the last "};" before "export const HVC_DATA"
const lines = content.split('\n');
let splitIdx = -1;
for (let i = 0; i < lines.length; i++) {
    if (lines[i].includes('export const HVC_DATA')) {
        splitIdx = i;
        break;
    }
}
...
let baseContent = '';
if (splitIdx !== -1) {
    baseContent = lines.slice(0, splitIdx).join('\n');
} else {
    baseContent = content;
}

// Now re-generate the HVC_DATA part with correct Portuguese characters
const hvcDataTs = `export const HVC_DATA = {
  secciones: [
  {
    "tipo": "mision1",
    "label": "Introdução",
    ...
    "rows": [
      {
        ...
        "detalhe": "-Instrutor explica as atribuições do número de sócios de acordo con a tabela disponível no PIC",
        "consejo": "",
        "herramientas": [],
        "iaPic": [
          {
      ...
      },
      {
        ...
        "detalhe": "-Instrutor explica como funciona o YEP, protocolos e mostra o painel de puntos qualificáveis",
      ...
      },
      {
        ...
        "detalhe": "- Instrutor apresenta o Painel de Promoções e explica que é posible consultar os detalhes das campanhas promocionais direcionadas aos sócios LATAM Pass durante o ano de 2025.",
        "consejo": "",
        "herramientas": [
          {
            "tipo": "Painel",
      ...
      {
        "macroTema": "Missão 1: Latam PASS",
        "tema": "Bloqueio por comercio de puntos ou resgates para terceiros",
  ...
  },
  {
    ...
    "rows": [
      ...
      },
      {
        "macroTema": "Missão 2: Vendas",
        "tema": "Compras com dinero retido na LATAM Wallet",
        "detalhe": "- Instrutor explica os caos de compra online quando não foi emitida, o valor fue debitado e ficou retido na LATAM Wallet",
        "consejo": "",
        "herramientas": [],
        "iaPic": [],
        "tiempo": "0:15:00"
...
console.log('src/lib/data.ts restored and HVC_DATA re-integrated correctly.');

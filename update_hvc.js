  ...
  // Missão 6: LATAM Pass
  {
    ...
    rows: [
      ...
      },
      {
        ...
        tiempo: '0:20:00',
        herramientas: [{ tipo: 'PIC', url: 'https://pic-latam.zendesk.com/hc/pt-br/articles/360053169173-Produto-Categorias-e-Benef%C3%ADcios-LATAM-Pass' }],
        iaPic: [],
        consejo: ''
      },
      {
        ...
        tiempo: '0:20:00',
        herramientas: [{ tipo: 'PIC', url: 'https://pic-latam.zendesk.com/hc/pt-br/articles/45049073432467-Processo-para-adicionar-o-segmento-Upgrade-UPG-Priority-no-Ifly' }],
        iaPic: [],
        consejo: ''
      },
      {
        ...
        tiempo: '0:40:00',
        herramientas: [{ tipo: 'PIC', url: 'https://pic-latam.zendesk.com/hc/pt-br/articles/45672456401683-16-10-25-FFP-LATAM-Pass-Mudan%C3%A7a-na-prioridade-de-atribui%C3%A7%C3%A3o-de-Upgrade-de-cabine' }],
        iaPic: [],
        consejo: ''
      },
      {
      ...
      },
      {
        ...
        tiempo: '0:25:00',
        herramientas: [{ tipo: 'PPT', url: 'https://docs.google.com/presentation/d/1jXlbwhz52XjXdx1fT6oZ2jP9ZxW6jzzD/edit?slide=id.p1#slide=id.p1' }],
        iaPic: [],
        consejo: ''
      },
      {
        ...
        dia: 3,
        tema: 'Atualização e gestão de contas  LATAM PASS',
        detalhe: '- Actividad: Instructor separa a la clase en equipos para que ingresen a PIC y en conjunto expliquen las 5 opciones que tiene un cliente para corregir datos, luego le pide a cada grupo que brevemente explique la opción y el flujo a seguir.',
        tiempo: '0:25:00',
        herramientas: [{ tipo: 'PPT', url: 'https://docs.google.com/presentation/d/1Vkq1VSYUz9Bxm3FxBpUmwii_-mvJ3RXQ/edit?slide=id.g3ab346bfee7_0_204#slide=id.g3ab346bfee7_0_204' }],
        iaPic: [],
        consejo: ''
      },
      {
      ...
      },
      {
        ...
        tiempo: '0:30:00',
        herramientas: [{ tipo: 'PIC', url: 'https://pic-latam.zendesk.com/hc/pt-br/articles/5443238652307-Travel-Bank' }],
        iaPic: [],
        consejo: ''
      }
    ]
  ...
  // Missão 7: Gestão de erros operacionais
  {
    ...
    rows: [
      ...
      },
      {
        ...
        tiempo: '0:20:00',
        herramientas: [{ tipo: 'Painel', url: 'https://lookerstudio.google.com/u/0/reporting/c6a5fbf4-0ec1-49d4-8b5a-b635da7185cf/page/p_jnbjcvnfpd' }],
        iaPic: [],
        consejo: ''
      },
      {
...
// Modificaremos todas las configuraciones root posibles
  ...
  if (station && station.exploracion) {
    for (const sector of ['frontLine', 'soporte', 'fieldSupport']) {
      ...
      if (idx !== -1) {
        ...
        // Add the new data replacing whatever was there
...
console.log('Successfully updated appConfig.json');

  ...
  // Missão 6: LATAM Pass
  {
    ...
    rows: [
      ...
      },
      {
        ...
        dia: 3,
        tema: 'Atualização e gestão de contas  LATAM PASS',
        detalhe: '- Actividad: Instructor separa a la clase en equipos para que ingresen a PIC y en conjunto expliquen las 5 opciones que tiene un cliente para corregir datos, luego le pide a cada grupo que brevemente explique la opção e o fluxo a seguir.',
        tiempo: '0:25:00',
  ...
  // Missão 8: Bagagem
  {
    ...
    rows: [
      ...
      },
      {
        ...
        detalhe: 'Conhecer  a matriz de fluxo de tópicos, subtópicos e actions',
        tiempo: '0:10:00',
    ...
    rows: [
      {
        ...
        tiempo: '1:00:00',
        herramientas: [{ tipo: '➖ NA', url: '' }], // Operação -> ➖ NA
        iaPic: [],
        consejo: ''
      },
      {
...
console.log('Successfully updated appConfig.json with ALL HVC data (including OJT).');

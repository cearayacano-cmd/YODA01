...
const wsRows = [
  ...
  },
  {
    ...
    tema: "Acompanhamento",
    detalhe: "O instrutor baseado no ppt:\n1- Mostra todos os pormenores para realizar o acompanhamento de um cliente, con o objetivo de realizar o fechamento efetivo da venda.\n2 - Desenvolve cada parte que compõe o acompanhamento.",
    tiempo: "0:40:00",
    herramientas: [{ tipo: "🖼️ PPT", url: "https://drive.google.com/drive/folders/1qkss1xvAmuJ27dz47puVB_sjJDNBwv0r?usp=drive_link" }],
    iaPic: []
  },
...
console.log('Added WS Vendas section to VENDAS_WS_12_DATA.');

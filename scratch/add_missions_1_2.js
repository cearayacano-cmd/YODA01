...
const m1Rows = [
  ...
  },
  {
    ...
    detalhe: "- O instrutor pede para que os alunos realizem reservas de acordo com o proposto no Genially y procedam con a isenção da taxa DU. ",
    tiempo: "0:10:00",
    herramientas: [{ tipo: "🖼️ PPT", url: "" }],
    iaPic: []
  },
...
const seccionesStartIdx = content.indexOf('secciones: [', startIdx) + 'secciones: ['.length;
...
const newContent = content.substring(0, seccionesStartIdx) + newSecciones + content.substring(content.indexOf(']', seccionesStartIdx));

fs.writeFileSync(path, newContent);
console.log('Added Mission 1 and Mission 2 to VENDAS_WS_12_DATA.');

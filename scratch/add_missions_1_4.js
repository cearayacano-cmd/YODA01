...
const newContent = content.substring(0, sectionsStartIdx) + newSections + content.substring(content.indexOf(']', sectionsStartIdx));

fs.writeFileSync(path, newContent);
console.log('Added Missions 1, 2, 3, and 4 to VENDAS_WS_12_DATA.');

...
const m3Rows = [
  ...
  },
  {
    ...
    detalhe: "- Instrutor menciona que a atividade é individual e tem como finalidade fixar o conteúdo aprendido \n- Instrutor envia link EducaPlay e explica tipo e tempo de (acordo com cronograma) para praticarem\nVale ressaltar que é possível jogar más de uma vez, caso terminem antes do prazo ",
    tiempo: "0:10:00",
    herramientas: [
  ...
  },
  {
    ...
    detalhe: "- O instrutor pede para que os alunos assistam aos vídeos com dúvidas de passageiros e elege um aluno diferente para entregar cada solución. A resposta correta está no rodapé do PPT.",
    tiempo: "0:30:00",
    herramientas: [{ tipo: "🖼️ PPT", url: "" }],
    iaPic: []
  },
...
const m4Rows = [
  ...
  },
  {
    ...
    detalhe: "- Instrutor introduz processos realizados pelo canal novoz. Revisa os procesos que estão disponíveis para a solicitação e recepção de documentos estando online com o cliente, enfatizando os passos do processo WhatsApp e Chat, em seguida mostra o paso a paso.",
    tiempo: "0:30:00",
  ...
  },
  {
    macroTema: "Prática",
    tema: "Casos",
    detalhe: "- Instrutor mostra PPT com exemplos de casos reais e analiza junto com os alunos.",
    tiempo: "1:00:00",
